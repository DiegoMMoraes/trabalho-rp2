...
colunas_para_remover = [
    ...
    'IN_INSE', 'INSE_ALUNO',
    # Adicionando perguntas não-comuns (Q23 - Pandemia)
    'TX_RESP_Q23a', 'TX_RESP_Q23b', 'TX_RESP_Q23c', 'TX_RESP_Q23d',
    'TX_RESP_Q23e', 'TX_RESP_Q23f', 'TX_RESP_Q23g', 'TX_RESP_Q23h', 'TX_RESP_Q23i' # 'i' não existe em 2021, mas não causa erro
]
...
print("Colunas mantidas no SAEB 2021:")
print(df.info())
df.to_csv('dados_filtrados_comuns_2021.csv')